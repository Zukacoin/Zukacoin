...
This mechanism has been integrated into Bitcore-Node-Zuka which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Zuka-Project/insight-api-Zuka#web-socket-api](https://github.com/Zuka-Project/insight-api-Zuka#web-socket-api) 
* API: [https://github.com/Zuka-Project/insight-api-Zuka#swifttx-transactions](https://github.com/Zuka-Project/insight-api-Zuka#swifttx-transactions) 
...
By default, the Zuka Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zuka Core daemon:

...
In order to support loading of multiple wallets in Zuka-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Zuka.cpp.
...
Changes to Zuka.cpp
----------------------
Zuka.cpp is the entry point into Zuka-qt, and as such, will require some minor modifications to provide hooks for

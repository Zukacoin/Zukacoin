...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zuka Core Zuka-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Zuka-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Zuka transaction") + "\n" +
                               "  Zuka-tx [options] -create [commands]   " + _("Create hex-encoded Zuka transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Zuka transaction

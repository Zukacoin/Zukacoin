...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zuka features */
        {"Zuka", "masternode", &masternode, true, true, false},
        {"Zuka", "listmasternodes", &listmasternodes, true, true, false},
        {"Zuka", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Zuka", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Zuka", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Zuka", "masternodedebug", &masternodedebug, true, true, false},
        {"Zuka", "startmasternode", &startmasternode, true, true, false},
        {"Zuka", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Zuka", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Zuka", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Zuka", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Zuka", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Zuka", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Zuka", "mnbudget", &mnbudget, true, true, false},
        {"Zuka", "preparebudget", &preparebudget, true, true, false},
        {"Zuka", "submitbudget", &submitbudget, true, true, false},
        {"Zuka", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Zuka", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Zuka", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Zuka", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Zuka", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Zuka", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Zuka", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Zuka", "checkbudgets", &checkbudgets, true, true, false},
        {"Zuka", "mnsync", &mnsync, true, true, false},
        {"Zuka", "spork", &spork, true, true, false},
        {"Zuka", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Zuka", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Zukad, or the -server option to Zuka-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Zuka-cli " + methodname + " " + args + "\n";
}

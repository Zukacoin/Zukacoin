...
// Copyright (c) 2019 The Zuka developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (0, uint256("0x0000048088373d234635bdd77ce9fff65c8094f6fc18425ff7230ff2b2fc2e9d"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 89743;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Zuka starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "Zuka coin";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1591899020;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22177056;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000048088373d234635bdd77ce9fff65c8094f6fc18425ff7230ff2b2fc2e9d"));
        assert(genesis.hashMerkleRoot == uint256("0x78e937bde55d58db8fe846ea20465a61c909a3db0437fb4d5f7a31cdca87d28a"));
        ...
        nStartMasternodePayments = 1591899020;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("049c4bf0b18b4b968c1136fa1fed29a02192eb4f7d249975e71dd955d667223b883e3f60442846747039b1065fb56c89177df6b09b46f71c8f8a02b7807aa42e42");
        nDefaultPort = 39795;
        nMaxReorganizationDepth = 100;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Zuka: 1 day
        nTargetSpacing = 1 * 60;  // Zuka: 1 minute
        nLastPOWBlock = 50000;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Zuka addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Zuka script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Zuka BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zuka BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zuka BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Zuka: 1 day
        nTargetSpacing = 1 * 60;        // Zuka: 1 minutes
